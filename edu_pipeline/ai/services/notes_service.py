...
class NotesService:
    ...
    def generate_notes(
        ...
        # The source length drives the study-time estimate, and the subject
        # selects discipline-appropriate prerequisite wording.
        enriched_data = KnowledgeEnrichmentService.enrich(
            analysis_data,
            subject=subject,
            source_char_count=len(theory_markdown or ""),
        )

#!/usr/bin/env python3
"""Repository module: BookRepository container and RepositoryService for book JSONs."""
...
from edu_pipeline.shared import OUTPUT_DIR, QA_SECTION_KEYS
...
# Aliases
find_topic = RepositoryService.find_topic
get_topic = RepositoryService.get_topic

__all__ = ["BookRepository", "RepositoryService", "QA_SECTION_KEYS"]
